...
function useSafeState(defaultValue) {
  var destroyRef = React13.useRef(false);
  var _React$useState = React13.useState(defaultValue), _React$useState2 = _slicedToArray(_React$useState, 2), value = _React$useState2[0], setValue = _React$useState2[1];
...
var genCSSVarRegister = (component, getDefaultToken, options) => {
  ...
  const useCSSVar = (rootCls) => {
    ...
    return [(node2) => injectStyle && cssVar ? import_react6.default.createElement(import_react6.default.Fragment, null, import_react6.default.createElement(CSSVarRegister, {
      rootCls,
      cssVar,
      component
...
var DisabledContext = React17.createContext(false);
var DisabledContextProvider = (_ref) => {
  let {
    children,
    disabled
  } = _ref;
  const originDisabled = React17.useContext(DisabledContext);
  return React17.createElement(DisabledContext.Provider, {
...
//# sourceMappingURL=chunk-JSYVD3HQ.js.map
